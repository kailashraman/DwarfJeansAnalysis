...
|---|---|---|---|---|---|---|---|---|
| `2017ApJ...838....8L` | `eridanus_2` | IMACS | 1.2 (Oct'15) / 1.0 (Nov'15) | 0.01 default (38 of 54 stars are 2-epoch and get the χ² test; 16 are single-epoch and the test no-ops) | none (single-instrument) | §3.1 | https://ui.adsabs.harvard.edu/abs/2017ApJ...838....8L | verified |
